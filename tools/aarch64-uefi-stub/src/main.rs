...
// ── UEFI console setup ──────────────────────────────────────────────
// The uefi-console feature enables UEFI console output (HDMI via GOP).
// Keyboard input before ExitBootServices is available but we boot
// straight through — no interactive prompt needed.
